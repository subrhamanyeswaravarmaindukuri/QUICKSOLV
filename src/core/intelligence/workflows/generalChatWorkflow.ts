...
export class GeneralChatWorkflow implements QuickSolvWorkflow {
  readonly taskType: QuickSolvTaskType = "GENERAL_CHAT";
...
export const generalChatWorkflow = new GeneralChatWorkflow();
